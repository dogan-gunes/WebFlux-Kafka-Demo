package com.dgn.reactivewikimedia.service;
...
public class WikimediaService {
    ...
    public WikimediaService(KafkaTemplate<String, String> kafkaTemplate) {
        ...
        this.wikimediaFlux = Flux.create(emitter -> {
    ...
    public void getWikimeaiEvent(
            String mesage,
            @Header(KafkaHeaders.RECEIVED_TOPIC) String topic){
        logger.info("Kafka Consume edildi ... mesaj {}",mesage);

        if (fluxSink!=null){
            fluxSink.next(mesage);
        }
